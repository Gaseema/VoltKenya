...
const checkIsProtected = (pathname, pathPrefix)=>{
...
async function proxy(request) {
    ...
    if (isAdminRoute) {
        ...
        try {
            ...
            const { jwtVerify } = await __turbopack_context__.A("[project]/node_modules/jose/dist/webapi/index.js [middleware] (ecmascript, async loader)");
            const secret = new TextEncoder().encode(process.env.JWT_SECRET || "super-secret-key-for-dev");
            const { payload } = await jwtVerify(sessionCookie, secret);
            if (payload.role !== "ADMIN") {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", request.url)); // Or to a 403 page
            }
        } catch (err) {
            // Invalid token
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/", request.url));
