...
async function sendOtpEmail(to, code) {
    ...
    try {
        const info = await transporter.sendMail({
            from: '"VoltKenya Auth" <no-reply@voltkenya.io>',
            to: to,
...
"[project]/app/api/auth/send-otp/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].otp.create({
            data: {
                email,
                code,
                expiresAt
        ...
        // Dispatch email
        const sent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mailer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOtpEmail"])(email, code);
        if (!sent) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c0aab05._.js.map