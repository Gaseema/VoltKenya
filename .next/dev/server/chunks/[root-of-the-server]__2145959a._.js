...
async function POST(req) {
    try {
        ...
        // Validate OTP
        const otpRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].otp.findFirst({
            where: {
                email,
                code
            },
        ...
        // Upsert User
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.upsert({
            where: {
                email
            },
            update: {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])(user.id, user.role);
        // Cleanup used OTP
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].otp.deleteMany({
            where: {
                email
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2145959a._.js.map