...
async function encrypt(payload) {
    return await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"](payload).setProtectedHeader({
        alg: "HS256"
    }).setIssuedAt().setExpirationTime("7 days").sign(key);
}
...
"[project]/app/api/bikes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const newBike = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bike.create({
            data: {
                name: data.name,
...
async function GET() {
    try {
        const bikes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bike.findMany({
            orderBy: {
                createdAt: "desc"
            }
        });
        // Parse the JSON string back to array before returning
        const parsedBikes = bikes.map((bike)=>({
                ...bike,
                images: JSON.parse(bike.images)
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(parsedBikes);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__012e14d9._.js.map